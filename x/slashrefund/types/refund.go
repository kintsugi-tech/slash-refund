...
func (r Refund) MustGetValidatorAddr() sdk.ValAddress {
...
func (r Refund) MustGetDelegatorAddr() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(r.DelegatorAddress)
	if err != nil {
		panic(err)
	}
	return addr
